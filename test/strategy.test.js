...
//       expect(url).to.equal(
//         'https://accounts.google.com/o/oauth2/v2/auth?access_type=offline&prompt=select_account&login_hint=john%40mail.com&response_type=code&client_id=ABC123',
//       );
//     });
...
//     it('should be redirected', function () {
//       expect(url).to.equal(
//         'https://accounts.google.com/o/oauth2/v2/auth?display=touch&response_type=code&client_id=ABC123',
//       );
//     });
...
//     it('should be redirected', function () {
//       expect(url).to.equal(
//         'https://accounts.google.com/o/oauth2/v2/auth?include_granted_scopes=true&response_type=code&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fdrive.file&client_id=ABC123',
//       );
//     });
...
//     it('should be redirected', function () {
//       expect(url).to.equal(
//         'https://accounts.google.com/o/oauth2/v2/auth?hd=mycollege.edu&response_type=code&client_id=ABC123',
//       );
//     });
...
//     it('should be redirected', function () {
//       expect(url).to.equal(
//         'https://accounts.google.com/o/oauth2/v2/auth?request_visible_actions=http%3A%2F%2Fschema.org%2FAddAction%20http%3A%2F%2Fschema.org%2FReviewAction&response_type=code&client_id=ABC123',
//       );
//     });
...
//     it('should be redirected', function () {
//       expect(url).to.equal(
//         'https://accounts.google.com/o/oauth2/v2/auth?openid.realm=http%3A%2F%2Fwww.example.com%2F&response_type=code&client_id=ABC123',
//       );
//     });
...
//     it('should be redirected', function () {
//       expect(url).to.equal(
//         'https://accounts.google.com/o/oauth2/v2/auth?approval_prompt=force&user_id=bob%40gmail.com&response_type=code&client_id=ABC123',
//       );
//     });
